...
def render(graph: Dict, pattern: str, path: str = './graph'):
    ...
    dot.unflatten().render(path, view=True, format='png', cleanup=True)

if __name__ == '__main__':
    import json
    import sys
    render(json.load(sys.stdin), '', '/tmp/graph')
